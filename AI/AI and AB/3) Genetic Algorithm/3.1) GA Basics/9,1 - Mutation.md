...
[[9,2 - Standard Mutation]] $\leftarrow$ Next

---
# What is Mutation?
Mutation is the probability that a gene, in a genotype, can take on a random value from the alleles that gene has.
- Mutation is applied, as an operator, to children.

Let G denote a genotype.
$$
G=<g_1,...g_{|G|}>
$$
$$
P(g_i \text{ is mutated}) = \alpha
$$
- Where alpha is the probability of mutation per gene.
